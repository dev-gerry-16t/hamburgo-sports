...
import menu from "../img/ui/icons/menu.svg";
import girl1 from "../img/illustrations/girl.png";
import ourMenu from "../img/ui/icons/menu.svg";
import aboutUs from "../img/ui/icons/arrow.svg";
          ...
          <div className="container">
            <div className="sb-top-bar">
              <a href="home-2.html" className="sb-logo-frame">
                {/* logo img */}
                <Image src={logo} alt="Starbelly" width={80} height={80} />
              </a>
              {/* menu */}
              ...
              <div className="row">
                  ...
                  <div className="sb-main-title-frame">
                    <div className="sb-main-title">
                      ...
                      <h1
                        ...
                        className="sb-mb-30"
                      >
                        ¡Siente <span>el sabor</span>, <br />
                        del <span>entretenimiento</span>!
                      </h1>
                      <p className="sb-text sb-text-lg sb-mb-30">
                        Disfruta de los mejores eventos deportivos
                        <br />
                        mientras degustas nuestros platillos
                      </p>
                      {/* button */}
                      <a href="menu-1.html" className="sb-btn">
                        <span className="sb-icon">
                          <Image src={ourMenu} alt="icon" />
                        </span>
                ...
                <div className="col-lg-6">
                  <div className="sb-illustration-1">
                    <Image src={girl1} alt="girl" className="sb-girl" />
            ...
            <div className="container">
              <div className="sb-footer-frame">
                ...
                <div className="sb-copy">
                  © Hamburgo Sports 2022. All Rights Reserved.
                </div>
              </div>
            </div>
          </footer>
